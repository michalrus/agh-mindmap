...
\todo[inline]{More about Scala?\ldots\\J. Wąs said, ``Nie lać wody!''. (If you'll excuse a lill' of Polish.) \\  \textit{I think we could add it in the end, depending on how much text we'll produce ;-)}}
