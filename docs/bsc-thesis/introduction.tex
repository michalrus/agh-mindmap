...
\todo[inline]{\igor{"ogólnie: kropka za cytowaniem (spacja różnie)"}}
\todo[inline]{\igor{"jak dwukropek przed wypunktowaniem, to nie może być ZDAŃ w wypunktowaniach --- czyli musi być od małej litery, bez kropki"}}
\todo[inline]{\igor{"jak bez dwukropka, to np. Steps described below need to be taken[KROPKA]"}}
\todo[inline]{\igor{"co do linku do GitHuba -- nie ma wymogu"}}
\todo[inline]{\igor{"Google Play!"}}
\todo[inline]{\igor{"możliwe dłuższe teksty do każdego node'a"}}
\todo[inline]{\igor{"możliwe załączniki do każdego node'a --- dowolny plik!"}}
\todo[inline]{\igor{"ikonki do node'ów jako załącznik png"}}
\todo[inline]{\igor{"dlaczego algorytm synchronizacji działa? albo np.: bazujemy na doświadczeniach Git, albo formalny dowód"}}
\todo[inline]{\igor{"długość formy"} \michal{dunno what he means :(}}
\todo[inline]{\igor{"żadnych skrótowców typu: we're, you're, it's. Tylko pełne formy!"}}
