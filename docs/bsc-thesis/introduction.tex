...
\chapter{\todo{Only \emph{MENTION} somewhere here about collaboration. ONE SENTENCE.}Introduction}
\label{chap:introduction}

\section{\todo{Remove headlines}What? The problem}
\label{sec:what}
...
\todo[inline]{A table with who-did-what.}
