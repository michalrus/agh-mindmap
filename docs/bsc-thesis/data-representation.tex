...
\todo[inline,caption=\michal{Wpisać \emph{TUTAJ jeszcze}, że nie robimy tych wszystkich bajerów, bo jak zobaczy ERD, \cref{fig:erd}, to znów to sobie przypomni!}]{\igor{"co z \emph{relacjami} między node'ami niespokrewnionymi? Chodzi o kręskę między dowolnymi node'ami. co z notatkami, ikonami, załącznikami, XMind compatibility"}}
