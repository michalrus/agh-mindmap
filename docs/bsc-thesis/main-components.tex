...
The UI of our consist of the following main components (compare with \cref{fig:diagram-components-android}):
...
Our Akka application consists of components described below (compare with \cref{fig:diagram-components-akka}).
