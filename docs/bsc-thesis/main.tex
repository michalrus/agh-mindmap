...
XMind files (workbooks) are saved as an archive of mainly .xml files, of which two are the most important and required to save a map. First, content.xml stored data and its hierarchy, and the second, \inlinecode{META-INF/manifest.xml} being the list of files included in the archive. 
