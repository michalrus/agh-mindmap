...
\todo[inline]{\igor{"prosty OBRAZEK z czego się składa system: z serwera i klienta, czyli:   SERWER <------ SYSTEM -------> KLIENT ; zaznaczone też główne składowe (tylko po kilka, 2-3) klienta i serwera"}}

\todo[inline]{\igor{"jakiś inny obrazek, np. Data Flow Diagram. Cokolwiek!"}}
